...
app.use((req: Request, res: Response, next: NextFunction) => {
  ...
  res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Requested-With, Accept, OpenAI-Organization, OpenAI-Project, X-Request-ID, Client-Request-Id, x-client-request-id, X-Username, x-username');
...
app.use('/chat', (_req: Request, res: Response) => { res.sendFile(indexPath); });
